...
public class AddingNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _news=(EditText)findViewById(R.id.news_details);
        _submit=(Button)findViewById(R.id.submit_news);
        _submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url="http://192.168.0.107:80/nstu/api/news.php";
                ...
                Toast.makeText(getApplicationContext(),"INFO published successfully!!",Toast.LENGTH_LONG).show();
