...
public class MainActivity extends AppCompatActivity {
   // TextView show_data;
    ...
    void fetchingData(){
        String myURL="http://192.168.0.107:80/nstu/api/getinfo.php";
        ...
        com.nstu.www.news.AppController.getInstance().addToRequestQueue(jsonArrayRequest);
